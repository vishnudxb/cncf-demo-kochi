...
tar cf - ./cncf_intermediate.csr | kubectl exec -i -i $VAULT_POD -n $VAULT_NAMESPACE --context $VAULT_CLUSTER_CONTEXT -- tar xf - -C /tmp/cncf_intermediate.csr
...
tar cf - ./cncfintermediate.cert.pem | kubectl exec -i -i $VAULT_POD -n $VAULT_NAMESPACE --context $VAULT_CLUSTER_CONTEXT -- tar xf - -C /tmp/cncfintermediate.cert.pem
